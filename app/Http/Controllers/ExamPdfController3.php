...
class ExamPdfController3 extends Controller
{
	...
	public function downbyreportcard(Request $request)
	{
		...
		if ($request->department_id == 1) // Primary 
		{
			if ($stuclass == 1 || $stuclass == 2) {
				...
				foreach ($getstudents['data'] as $stu) {
					$sno++;
					$attendance_no = isset($stu['attendance_no']) ? $stu['attendance_no'] : "00";
					//$output .=$this->generateStudentReportCard01($request, $stu, $getprimarypapers, $stuclass,$section, $fonturl, $getprimarysubjects, $specialsubject1,$getspecialpapers,$specialsubject2,$description,$specialsubject3,$specialsubject4,$getteacherdata);
					$output .= View::make('admin.student_report.generateReportCard01', [
						'attendance_no' => $attendance_no,
						'request'=> $request,
						'stu' => $stu,
						'stuclass' => $stuclass,
						'section' => $section,
						'getprimarypapers' => $getprimarypapers,
						'getspecialpapers' => $getspecialpapers,
						'fonturl' => $fonturl,
						'getprimarysubjects' => $getprimarysubjects,
						'specialsubject1' => $specialsubject1,
						'specialsubject2' => $specialsubject2,
						'description' => $description,
						'specialsubject3' => $specialsubject3,
						'specialsubject4' => $specialsubject4,
			...
			if ($stuclass == 3 || $stuclass == 4) {
				...
				foreach ($getstudents['data'] as $stu) {
					$sno++;
					//$output .=$this->generateStudentReportCard02($request, $stu, $getprimarypapers, $stuclass,$section, $fonturl, $getprimarysubjects, $specialsubject1,$getspecialpapers,$specialsubject2,$description,$specialsubject3,$specialsubject4,$getteacherdata,$specialsubject6,$specialsubject5);
					$attendance_no = isset($stu['attendance_no']) ? $stu['attendance_no'] : "00";
					$output .= View::make('admin.student_report.generateReportCard02', [
						'attendance_no' => $attendance_no,
						'request'=> $request,
						'stu' => $stu,
						'stuclass' => $stuclass,
						...
						'specialsubject3' => $specialsubject3,
						'specialsubject4' => $specialsubject4,
						'specialsubject5' => $specialsubject5,
						'specialsubject6' => $specialsubject6,
						'getteacherdata' => $getteacherdata,
					])->render();
				}
			}
			if ($stuclass == 5 || $stuclass == 6) {
				...
				foreach ($getstudents['data'] as $stu) {
					$sno++;
				//	$output .= $this->generateStudentReportCard03($request, $stu, $getprimarypapers, $stuclass,$section, $fonturl, $getprimarysubjects, $specialsubject1,$getspecialpapers,$specialsubject2,$description,$specialsubject3,$specialsubject4,$getteacherdata,$specialsubject5);
					$attendance_no = isset($stu['attendance_no']) ? $stu['attendance_no'] : "00";
					$output .= View::make('admin.student_report.generateReportCard03', [
						'attendance_no' => $attendance_no,
						'request'=> $request,
						'stu' => $stu,
						'stuclass' => $stuclass,
		...
		} elseif ($request->department_id == 2) // Secondary 
		{
			...
			foreach ($getstudents['data'] as $stu) {
				$sno++;
				//$output .=$this->generateStudentReportCard04($request, $stu, $getprimarypapers, $stuclass,$section, $fonturl, $getprimarysubjects, $specialsubject1,$getspecialpapers,$specialsubject2,$description,$specialsubject3,$specialsubject4,$getteacherdata,$specialsubject5);
				$attendance_no = isset($stu['attendance_no']) ? $stu['attendance_no'] : "00";
					$output .= View::make('admin.student_report.generateReportCard04', [
						'attendance_no' => $attendance_no,
						'request'=> $request,
						'stu' => $stu,
						'stuclass' => $stuclass,
	...
	public function generateStudentReportCard01($request,$stu, $getprimarypapers, $stuclass, $section, $fonturl,$getprimarysubjects,$specialsubject1,$getspecialpapers,$specialsubject2,$description,$specialsubject3,$specialsubject4,$getteacherdata){
		$output = '';
		$attendance_no = isset($stu['attendance_no']) ? $stu['attendance_no'] : "00";
		$attendance_no = isset($stu['attendance_no']) ? $stu['attendance_no'] : "00";
					$output .= '<!DOCTYPE html>
	...
	public function generateStudentReportCard02($request, $stu, $getprimarypapers, $stuclass,$section, $fonturl, $getprimarysubjects, $specialsubject1,$getspecialpapers,$specialsubject2,$description,$specialsubject3,$specialsubject4,$getteacherdata,$specialsubject6,$specialsubject5)
	{
		$output = '';
		$attendance_no = isset($stu['attendance_no']) ? $stu['attendance_no'] : "00";
	...
	public function generateStudentReportCard03($request, $stu, $getprimarypapers, $stuclass,$section, $fonturl, $getprimarysubjects, $specialsubject1,$getspecialpapers,$specialsubject2,$description,$specialsubject3,$specialsubject4,$getteacherdata,$specialsubject5){
		$output= '';
		$attendance_no = isset($stu['attendance_no']) ? $stu['attendance_no'] : "00";
					$output .= '<!DOCTYPE html>
						<html lang="en">
	...
	public function generateStudentReportCard04($request, $stu, $getprimarypapers, $stuclass,$section, $fonturl, $getprimarysubjects, $specialsubject1,$getspecialpapers,$specialsubject2,$description,$specialsubject3,$specialsubject4,$getteacherdata,$specialsubject5){
		$output='';
		$attendance_no = isset($stu['attendance_no']) ? $stu['attendance_no'] : "00";
				$output .= '<!DOCTYPE html>
					<html lang="en">
