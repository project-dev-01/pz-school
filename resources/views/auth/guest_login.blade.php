...
<head>
    ...
    <!-- <link href="{{ asset('css/custom/parent_login.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('css/custom/opensans-font.css') }}" rel="stylesheet" type="text/css" />-->
    <link href="{{ asset('css/custom-minified/parent_login.min.css') }}" rel="stylesheet" type="text/css" />
            ...
            <div class="auth-fluid-form-box">
                <div class="align-items-center d-flex h-100">
                    <div class="card-body">
                        ...
                        <!-- form -->
                        <div class="form">
                            <form id="LoginAuth" action="{{ route('guest.authenticate') }}" method="post">
                                <h1 class="welcomeback">{{ __('messages.welcome_back') }}, {{ __('messages.guest_portal') }}</h1>
                                ...
                                <div class="form-group mb-0 text-center">
                                    ...
                                    <!-- <a href="{{route('guest.application.index')}}" class="btn btn-block signin" >{{ __('messages.sign_in') }} </a> -->
                                </div>
