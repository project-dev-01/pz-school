...
<head>
    ...
    <!-- <link href="{{ asset('css/font-awesome.min.css') }}" rel="stylesheet" type="text/css" id="bs-dark-stylesheet" /> -->
...
<body class="body password">
    ...
    <script src="{{ asset('bootstrap/js/twitter-bootstrap.min.js') }}"></script>
