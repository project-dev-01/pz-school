...
<head>
    ...
    <!-- <link href="{{ asset('css/custom/student_login.css') }}" rel="stylesheet" type="text/css" />
    <link href="{{ asset('css/custom/opensans-font.css') }}" rel="stylesheet" type="text/css" /> -->
    <link href="{{ asset('css/custom-minified/student_login.min.css') }}" rel="stylesheet" type="text/css" />
...
<body class="loading auth-fluid-pages pb-0">
    <div class="auth-fluid">
        <div class="col-md-6">
            <div class="auth-fluid-right text-center studentlogin">
                <div class="">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form">
                            <form id="LoginAuth" action="{{ route('student.authenticate') }}" method="post">
                                <h1 class="welcomeback">{{ __('messages.welcome_back') }}, {{ __('messages.student_portal') }}</h1>
                                ...
                                <div class="form-group">
                                    <input class="form-control login-email" type="email" id="email" name="email" value="{{ Cookie::get('email') ? Cookie::get('email'):'' }}" required="" placeholder="{{ __('messages.enter_your_email') }}">
                                </div>
