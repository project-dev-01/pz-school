                ...
                <div class="tab-pane tt-indent-none" id="tt-tab-03" role="tabpanel">
                    ...
                    <div class="tt-topic-list">
                        ...
                        <div class="tt-item">
                            ...
                            <div class="tt-col-description">
                                <h6 class="tt-title">
                                    <a href="{{route('staff.forum.page-single-topic-val',[$value['created_post_id'],$value['user_id']])}}">
                                        {{ $value['topic_title'] }}
                                    </a>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="tt-item">
                                        <div class="tt-item-header">
                                            <ul class="tt-list-badge">
                                                <li><a href="{{route('staff.forum.page-categories-single-val',[$value['categId'],$value['user_id'],$value['category_names']])}}">
