...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <!--- end row -->
        @include('staff.shortcut_links.add')
        @include('staff.shortcut_links.edit')
    </div>
</div>
<!-- container -->
@endsection
...
<script>
    //bank routes
    var shortcutList = "{{ route('staff.shortcut_link.list') }}";
    var shortcutDetails = "{{ route('staff.shortcut_link.details') }}";
    var shortcutDelete = "{{ route('staff.shortcut_link.delete') }}";
...
<script src="{{ asset('js/custom/staff_shortcut_links.js') }}"></script>
