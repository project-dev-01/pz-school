...
@section('title',' ' . __('messages.analytic') . '')
...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="page-title-box" style="display: inline-flex; align-items: center;margin-bottom:10px;margin-top:10px">
                ...
                <i data-feather="activity" class="icon-dual" style="color:#3A4265"></i>
                </div>
                <h4 class="page-title" style="margin-left: 10px;">{{ __('messages.analytic') }}</h4>
            </div>
        </div>
    </div>
