                    ...
                    <div class="tt-item">
                        <div class="tt-item-header">
                            <ul class="tt-list-badge">
                                <li><a href="{{route('student.forum.page-categories-single-val',[$value['categId'],$value['user_id'],$value['category_names']])}}">
                            ...
                            <h4 class="tt-title"><a href="{{route('student.forum.page-single-user')}}">{{ __('messages.threads') }}</a></h4>
                        </div>
