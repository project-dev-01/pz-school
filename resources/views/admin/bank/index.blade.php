...
@section('title',' ' .  __('messages.bank') . '')
    ...
    <div class="row">
        ...
        <div class="page-title-box" style="display: inline-flex; align-items: center;margin-bottom:5px;margin-top:5px">
                ...
                <ol class="breadcrumb m-0 responsivebc">
                    ...
                    <li class="breadcrumb-item"><a href="javascript: void(0);">{{ __('messages.bank') }}</a></li>
                </ol>
        ...
        <div class="col-lg-12">
            ...
            <ul class="nav nav-tabs" style="display: inline-block;">
                ...
                <div class="form-group pull-right">
                    <div class="">
                        <button type="button" class="btn add-btn btn-rounded waves-effect waves-light" id="bankModal">{{ __('messages.add') }}</button>
                    </div>
                </div>
                    <div class="table-responsive">
                        <table class="table dt-responsive nowrap w-100" id="bank-table">
                            <thead>
                                <tr>
                                    <th>#</th>
...
<script>
    //bank routes
    var bankList = "{{ route('admin.bank.list') }}";
    var bankDetails = "{{ route('admin.bank.details') }}";
    var bankDelete = "{{ route('admin.bank.delete') }}";
    // lang change name start
    var deleteTitle = "{{ __('messages.are_you_sure') }}";
    var deleteHtml = "{{ __('messages.delete_this_bank') }}";
