    ...
    <div class="row">
        ...
        <div class="page-title-box" style="display: inline-flex; align-items: center;margin-bottom:5px;margin-top:5px">
                ...
                <ol class="breadcrumb m-0 responsivebc">
                    ...
                    <li class="breadcrumb-item"><a href="javascript: void(0);">{{ __('messages.add_designation') }}</a></li>
                </ol>
        ...
        <div class="col-lg-12">
            <div class="card">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <h4 class="nav-link">{{ __('messages.designation') }}<h4>
                    </li>
                </ul><br>
                <div class="form-group pull-right">
                    <div class="col-xs-2 col-sm-2">
                        <button type="button" class="btn add-btn btn-rounded waves-effect waves-light" data-toggle="modal" data-target="#addDesignationModal">{{ __('messages.add') }}</button>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table dt-responsive nowrap w-100" id="designation-table">
                            <thead>
                                <tr>
                                    <th>#</th>
...
<script>
    ...
    // Get PDF Footer Text
    var header_txt="{{ __('messages.designation') }}";
