    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myaddHostelModalLabel">{{ __('messages.add_hostel') }}</h4>
            ...
            <div class="modal-body">
                <form id="hostelForm" method="post" action="{{ route('admin.hostel.add') }}" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control select2-multiple" data-toggle="select2" name="watchman[]" multiple="multiple" data-placeholder="{{ __('messages.choose_the_warden_name') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="address" class="form-control" placeholder="{{ __('messages.enter_hostel_address') }}">
