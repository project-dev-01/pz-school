...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <h4 class="navv">{{ __('messages.category') }}
                            <h4>
                    </li>
                </ul><br>
                <div class="form-group pull-right">
                    <div class="col-xs-2 col-sm-2">
                        ...
                        <button type="button" class="btn add-btn btn-rounded waves-effect waves-light" data-toggle="modal" data-target="#addHostelCategoryModal">{{ __('messages.add') }}</button>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table dt-responsive nowrap w-100" id="hostel-category-table">
                            <thead>
                                <tr>
                                    <th>#</th>
        ...
        <!--- end row -->
        @include('admin.hostel_category.add')
        @include('admin.hostel_category.edit')
    </div>
</div>
<!-- container -->
@endsection
...
<script>
    ...
    // Get PDF Footer Text
    var header_txt="{{ __('messages.category') }}";
