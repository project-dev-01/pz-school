    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myaddSectionModalLabel">{{ __('messages.add_class') }}</h4>
            ...
            <div class="modal-body">
                <form id="sectionForm" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="sectionName" name="name" class="form-control" placeholder="{{ __('messages.enter_name') }}">
                    </div>
                    <div class="form-group">
