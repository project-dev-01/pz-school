                            ...
                            <div class="card-box">
                                ...
                                <div id="day_table" class="tables" style="display:none">
                                    ...
                                    <div class="form-group text-right m-b-0">
                                        ...
                                        <form method="post" action="{{ route('admin.attendance.student_pdf_day_test')}}">
                                            @csrf
                                ...
                                <div id="term_table" class="tables" style="display:none">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <table class="">
                                                    ...
                                                    <th><button type="button" class="btn btn-xs btn-warning waves-effect waves-light"><i class="mdi mdi-clock-outline"></i> {{ __('messages.late') }}</button></th> -->
                                                        <th style="text-align:center">Total Students : 28</th>
                                                        <th style="text-align:center">Total School Days : 24</th>
                                    ...
                                    <div class="form-group text-right m-b-0">
                                        ...
                                        <form method="post" action="{{ route('admin.attendance.student_pdf_term_test')}}">
                                            @csrf
                                            <input type="hidden" name="subject_id" id="downExcelSubject">
                                            <input type="hidden" name="class_id" id="downExcelClass">
                                            <input type="hidden" name="section_id" id="downExcelSection">
                                ...
                                <div id="year_table" class="tables" style="display:none">
                                    <div class="row">
                                        <div class="col-md-8"></div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                    ...
                                    <div class="form-group text-right m-b-0">
                                        ...
                                        <form method="post" action="{{ route('admin.attendance.student_pdf_year_test')}}">
                                            @csrf
                                            <input type="hidden" name="subject_id" id="downExcelSubject">
                                            <input type="hidden" name="class_id" id="downExcelClass">
                                            <input type="hidden" name="section_id" id="downExcelSection">
                                ...
                                <div id="month_table" class="tables" style="display:none">
                                    <div class="row">
                                        <div class="col-md-8"></div>
                                        <div class="col-md-4">
                                            <div class="form-group">
