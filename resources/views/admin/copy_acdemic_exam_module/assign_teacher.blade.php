    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <!-- end row-->
                    <form id="createCopyAssignTeacher" autocomplete="off">
                        <div class="row">
                            <div class="col-md-4">
...
@section('scripts')
<script>
    var acdemicCopyAssignTeacherUrl = "{{ config('constants.api.acdemic_copy_assign_teacher') }}";
</script>
<script src="{{ asset('public/js/custom/copy_academic_exams.js') }}"></script>
@endsection