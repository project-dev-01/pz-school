...
@section('title',' ' .  __('messages.add_staff_category') . '')
    ...
    <div class="row">
        ...
        <div class="page-title-box" style="display: inline-flex; align-items: center;margin-bottom:5px;margin-top:5px">
                ...
                <ol class="breadcrumb m-0 responsivebc">
                    ...
                    <li class="breadcrumb-item"><a href="javascript: void(0);">{{ __('messages.add_staff_category') }}</a></li>
                </ol>
...
<script>
    ...
    // lang change name end
     // Get PDF Footer Text
    var header_txt="{{ __('messages.staff_category') }}";
