...
<main id="tt-pageContent" class="tt-offset-small">
    <div class="container">
        <div class="tt-tab-wrapper card" style="background:white;margin-top:20px;">
                ...
                <div class="tab-pane" id="tt-tab-02" role="tabpanel">
                    <div class="tt-wrapper-inner tt-layout-tab">
                        ...
                        <ul class="tt-list-dot tt-indent-top01">
                            ...
                            <li>To reach the common ground of understanding each other; to be respectful and supportive emotionally.</li>
                        </ul>
