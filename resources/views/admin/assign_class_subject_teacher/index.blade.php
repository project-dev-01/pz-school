...
@section('title',' ' .  __('messages.teacher_assign') . '')
    ...
    <div class="row">
        ...
        <div class="page-title-box" style="display: inline-flex; align-items: center;margin-bottom:5px;margin-top:5px">
                ...
                <li class="breadcrumb-item"><a href="javascript: void(0);">{{ __('messages.academic') }}</a></li>
                    ...
                    <li class="breadcrumb-item"><a href="javascript: void(0);">{{ __('messages.teacher_assign') }}</a></li>
                </ol>
        ...
        <div class="col-lg-12">
            ...
            <ul class="nav nav-tabs" style="display: inline-block;">
                    <li class="nav-item d-flex justify-content-between align-items-center">
                                ...
                                <h4 class="navv">
                                {{ __('messages.assign_subjects_teacher') }}
                                </h4>
                                <!-- Up and Down Arrows -->
