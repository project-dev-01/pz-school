    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myeditAssClassSubjectModelLabel">{{ __('messages.edit_assign_subject_teacher') }}</h4>
            ...
            <div class="modal-body">
                <form id="updateAssignClassSubject" autocomplete="off">
                    ...
                    <div class="form-group">
                        <label for="edit_department_id">{{ __('messages.department') }}<span class="text-danger">*</span></label>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="editsubjectType" name="type">
                            ...
                            <option value="1">{{ __('messages.alternative') }}</option>
                        </select>
                    </div>
                    <div class="form-group">
