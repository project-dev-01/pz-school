        ...
        <div class="col-12">
            <div class="page-title-box" style="display: inline-flex; align-items: center;margin-bottom:5px;margin-top:5px">
                ...
                <ol class="breadcrumb m-0 responsivebc">
                    ...
                    <li class="breadcrumb-item"><a href="javascript: void(0);"> {{ __('messages.dashboard_hideunhide') }}</a></li>
                </ol>
                    ...
                    <div class="card">
                        <ul class="nav nav-tabs" style="display: inline-block;">
                            <li class="nav-item d-flex justify-content-between align-items-center">
                                ...
                                <h4 class="navv">
                                    {{ __('messages.dashboard_hideunhide') }}
                                </h4>
                                <!-- Up and Down Arrows -->
                        ...
                        <div class="card-body collapse show DemoBS2">
                            <!-- Toogle Buttons -->
                            <div>
                                <div class="container">
                                    <div class="row">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>8</td>
                                            <td>{{ __('messages.StudentNewJoining') }}</td>
