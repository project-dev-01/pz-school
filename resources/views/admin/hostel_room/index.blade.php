            ...
            <div class="card">
                ...
                <div class="form-group pull-right">
                    <div class="col-xs-2 col-sm-2">
                        ...
                        <button type="button" class="btn btn-primary-bl btn-rounded waves-effect waves-light" style="width:150px" data-toggle="modal" data-target="#addHostelRoomModal">Add Hostel Room</button>
                    </div>
                </div>
                <div class="card-body">
