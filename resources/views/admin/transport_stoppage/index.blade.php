...
@section('title',' ' .  __('messages.stoppage') . '')
        ...
        <div class="col-lg-12">
            <div class="card">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <h4 class="navv">{{ __('messages.stoppage') }}<h4>
                    </li>
                </ul><br>
                <div class="form-group pull-right">
                    <div class="col-xs-2 col-sm-2">
                        <!-- <a href="{{ route('admin.add_classes')}}" class="btn btn-primary btn-rounded waves-effect waves-light">Add Class</a> -->
                        <button type="button" class="btn add-btn btn-rounded waves-effect waves-light" data-toggle="modal" data-target="#addTransportStoppageModal">{{ __('messages.add') }}</button>
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table w-100 nowrap" id="transport-stoppage-table">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>{{ __('messages.stop_position') }}</th>
...
<script>
    ...
    // Get PDF Footer Text
    var header_txt="{{ __('messages.stoppage') }}";
