                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control prev_school_form" {{$readonly_phase_1}} id="school_last_attended" value="{{ isset($application['school_last_attended']) ? $application['school_last_attended'] : ''}}" name="school_last_attended" placeholder="{{ __('messages.enter_school_name') }}" aria-describedby="inputGroupPrepend">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="school_country">{{ __('messages.country') }}<span class="text-danger">*</span></label>
                                                        <input type="text" maxlength="50" {{$readonly_phase_1}} id="school_country" value="{{ isset($application['school_country']) ? $application['school_country'] : ''}}" name="school_country" class="form-control prev_school_form country" placeholder="{{ __('messages.country') }}" data-parsley-trigger="change">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="school_state">{{ __('messages.state_province') }}<span class="text-danger">*</span></label>
                                                        <input type="text" class="form-control prev_school_form" {{$readonly_phase_1}} id="school_state" value="{{ isset($application['school_state']) ? $application['school_state'] : ''}}" name="school_state" placeholder="{{ __('messages.enter') }} {{ __('messages.state_province') }}" aria-describedby="inputGroupPrepend">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control prev_school_form" {{$readonly_phase_1}} id="school_city" value="{{ isset($application['school_city']) ? $application['school_city'] : ''}}" name="school_city" placeholder="{{ __('messages.enter') }} {{ __('messages.city') }}" aria-describedby="inputGroupPrepend">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="school_postal_code">{{ __('messages.postal_code') }}<span class="text-danger">*</span></label>
                                                        <input type="text" class="form-control prev_school_form number_validation" {{$readonly_phase_1}} id="school_postal_code" value="{{ isset($application['school_postal_code']) ? $application['school_postal_code'] : ''}}" name="school_postal_code" placeholder="{{ __('messages.enter') }} {{ __('messages.postal_code') }}" aria-describedby="inputGroupPrepend">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="state" {{$readonly_phase_2}} value="{{ isset($application['state']) ? $application['state'] : ''}}" name="state" placeholder="{{ __('messages.enter') }} {{ __('messages.state_province') }}" aria-describedby="inputGroupPrepend">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="country">{{ __('messages.country') }}<span class="text-danger">*</span></label>
                                                    <input type="text" maxlength="50" id="country" class="form-control student_country" placeholder="{{ __('messages.country') }}" {{$readonly_phase_2}} value="{{ isset($application['country']) ? $application['country'] : ''}}" name="country" data-parsley-trigger="change">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select id="phase_2_status" name="phase_2_status" class="form-control">
                                                        ...
                                                        <option {{ isset($application['phase_2_status']) ? $application['phase_2_status'] == "Approved" ? 'selected' : '' : '' }} value="Approved">{{ __('messages.phase_2_approved') }}</option>
                                            ...
                                            <div class="col-md-4" id="status_after_approval_show" style="display:{{$phase_2_status}}">
                                                <div class="form-group">
                                                    <label for="status_after_approval">{{ __('messages.status_after_approval') }}</label>
                                                    <select id="status_after_approval" name="status_after_approval" class="form-control">
                                                        ...
                                                        <option {{ isset($application['status_after_approval']) ? $application['status_after_approval'] == "Payment confirmed" ? 'selected' : '' : '' }} value="Payment confirmed">{{ __('messages.payment_confirmed') }}</option>
                                            ...
                                            <div class="col-md-4" id="official_date_show" style="display:{{$official_date}}">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group input-group-merge">
                                                        ...
                                                        <input type="text" class="form-control" id="official_date" value="{{ isset($application['official_date']) ? $application['official_date'] : date('Y-m-d')}}" name="official_date" placeholder="{{ __('messages.yyyy_mm_dd') }}" aria-describedby="inputGroupPrepend">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
