...
@section('title',' ' .  __('messages.excused_reason') . '')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">{{ __('messages.excused_reason') }}</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
        ...
        <div class="col-lg-12">
            <div class="card">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <h4 class="nav-link">{{ __('messages.excused_reason') }}<h4>
                    </li>
                </ul><br>
                <div class="form-group pull-right">
                    <div class="col-xs-2 col-sm-2">
                        <button type="button" class="btn add-btn btn-rounded waves-effect waves-light" data-toggle="modal" data-target="#addExcusedReasonModal">{{ __('messages.add') }}</button>
                    </div>
                </div>
                <div class="card-body">
...
<script>
    ...
    // Get PDF Footer Text
    var header_txt="{{ __('messages.excused_reason') }}";
    var footer_txt="{{ session()->get('footer_text') }}";
    // Get PDF Header & Footer Text End
</script>

<script src="{{ asset('js/custom/excused_reason.js') }}"></script>
