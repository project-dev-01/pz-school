    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Fees Type</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
        ...
        <div class="col-lg-12">
            <div class="card">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <h4 class="nav-link">Fees Type<h4>
                    </li>
                </ul><br>
                <div class="form-group pull-right">
                    <div class="col-xs-2 col-sm-2">
                        <button type="button" class="btn add-btn btn-rounded waves-effect waves-light" data-toggle="modal" data-target="#addFeesTypeModal">Add</button>
                    </div>
                </div>
                <div class="card-body">
...
<script src="{{ asset('public/js/custom/fees_type.js') }}"></script>
