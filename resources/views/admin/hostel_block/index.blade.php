            ...
            <div class="card">
                ...
                <div class="form-group pull-right">
                    <div class="col-xs-2 col-sm-2">
                        ...
                        <button type="button" id="addHostelBlock"  class="btn add-btn btn-rounded waves-effect waves-light" data-toggle="modal" data-target="#addHostelBlockModal">Add</button>
                    </div>
                </div>
