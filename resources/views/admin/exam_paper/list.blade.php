...
@section('title',' ' .  __('messages.exam_paper') . '')
    ...
    <div class="row">
        ...
        <div class="page-title-box" style="display: inline-flex; align-items: center;margin-bottom:5px;margin-top:5px">
                ...
                <ol class="breadcrumb m-0 responsivebc">
                    ...
                    <li class="breadcrumb-item"><a href="javascript: void(0);">{{ __('messages.exam') }} </a></li>
                    <li class="breadcrumb-item"><a href="javascript: void(0);">{{ __('messages.exam_paper') }}</a></li>
                </ol>
...
<script>
    ...
    var header_txt="{{ __('messages.exam_hexam_paperall') }}";
    var footer_txt="{{ session()->get('footer_text') }}";
    // Get PDF Header & Footer Text End
</script>
<script src="{{ asset('js/custom/exam_paper.js') }}"></script>
