                                                                    ...
                                                                    <div class="mt-3 mt-sm-0">
                                                                        <ul class="list-inline font-13 text-sm-right">
                                                                            ...
                                                                            <li class="list-inline-item">
                                                                                ...
                                                                                <span class="badge badge-soft-success p-1" style="background-color: #77D9B0;color:black;">{{$today['priority']}}</span>
                                                                                @endif
                                                                                @if($today['priority'] == "Medium")
                                                                                <span class="badge badge-soft-info p-1" style="background-color: #E2C181;color:black;">{{$today['priority']}}</span>
                                                                                @endif
                                                                                @if($today['priority'] == "High")
                                                                                <span class="badge badge-soft-danger p-1" style="background-color: #E45555;color:black;">{{$today['priority']}}</span>
                                                                                @endif
                                                                            </li>
                                                                        </ul>
                                                                    </div>
                                                                        ...
                                                                        <div class="mt-3 mt-sm-0">
                                                                            <ul class="list-inline font-13 text-sm-right">
                                                                                ...
                                                                                <li class="list-inline-item">
                                                                                    ...
                                                                                    <span class="badge badge-soft-success p-1" style="background-color: #77D9B0;color:black;">{{$upcoming['priority']}}</span>
                                                                                    @endif
                                                                                    @if($upcoming['priority'] == "Medium")
                                                                                    <span class="badge badge-soft-info p-1" style="background-color: #E2C181;color:black;">{{$upcoming['priority']}}</span>
                                                                                    @endif
                                                                                    @if($upcoming['priority'] == "High")
                                                                                    <span class="badge badge-soft-danger p-1" style="background-color: #E45555;color:black;">{{$upcoming['priority']}}</span>
                                                                                    @endif
                                                                                </li>
                                                                            </ul>
                                                                        </div>
                                                                    ...
                                                                    <div class="d-sm-flex justify-content-between">
                                                                        <div class="mt-3 mt-sm-0">
                                                                            <ul class="list-inline font-13 text-sm-right">
                                                                                ...
                                                                                <li class="list-inline-item">
                                                                                    @if($old['priority'] == "Low")
                                                                                    <span class="badge badge-soft-success p-1" style="background-color: #77D9B0;color:black;">{{$old['priority']}}</span>
                                                                                    @endif
                                                                                    @if($old['priority'] == "Medium")
                                                                                    <span class="badge badge-soft-info p-1" style="background-color: #E2C181;color:black;">{{$old['priority']}}</span>
                                                                                    @endif
                                                                                    @if($old['priority'] == "High")
                                                                                    <span class="badge badge-soft-danger p-1" style="background-color: #E45555;color:black;">{{$old['priority']}}</span>
                                                                                    @endif
                                                                                </li>
                                                                            </ul>
                                                                        </div>
