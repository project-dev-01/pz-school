...
@section('title',' ' .  __('messages.sub_category') . '')
    ...
    <div class="row">
        ...
        <div class="page-title-box" style="display: inline-flex; align-items: center;margin-bottom:5px;margin-top:5px">
                ...
                <ol class="breadcrumb m-0 responsivebc">
                    ...
                    <li class="breadcrumb-item"><a href="javascript: void(0);">{{ __('messages.sub_category') }} </a></li>
                </ol>
            ...
            <ul class="nav nav-tabs" style="display: inline-block;">
                ...
                <div class="form-group pull-right">
                    <div class="">
                        ...
                        <button type="button" class="btn add-btn btn-rounded waves-effect waves-light" data-toggle="modal" data-target="#addSoapSubCategoryModal">{{ __('messages.add') }}</button>
                    </div>
                </div>             
...
<script src="{{ asset('js/custom/soap_sub_category.js') }}"></script>
