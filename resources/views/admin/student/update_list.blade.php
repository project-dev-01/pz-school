...
@section('title',' ' .  __('messages.student_update_list') . '')
    ...
    <div class="row">
        ...
        <div class="page-title-box" style="display: inline-flex; align-items: center;margin-bottom:5px;margin-top:5px">
                ...
                <ol class="breadcrumb m-0 responsivebc">
                    ...
                    <li class="breadcrumb-item"><a href="javascript: void(0);">{{ __('messages.student_update_list') }}</a></li>
                </ol>
        ...
        <div class="col-xl-12">
            <div class="card">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <h4 class="navv">{{ __('messages.student_update_list') }}<h4>
                    </li>
                </ul><br>
                <div class="card-body">
                    <br>
                        ...
                        <div class="col-sm-12">
                            <div class="">
                                <div class="table-responsive">
                                    <table class="table w-100 nowrap" id="student-update-table">
                                        <thead>
                                            <tr>
                                                <th>#</th>
