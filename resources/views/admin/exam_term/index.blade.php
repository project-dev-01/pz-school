            ...
            <div class="card">
                ...
                <div class="form-group pull-right">
                    <div class="col-xs-2 col-sm-2">
                        ...
                        <button type="button" class="btn btn-primary-bl btn-rounded waves-effect waves-light" data-toggle="modal" data-target="#addExamTermModal">{{ __('messages.add') }}</button>
                    </div>
                </div>
                <div class="card-body">
...
<script>
  ...
  // Get PDF Footer Text
    var header_txt="{{ __('messages.exam_term') }}";
