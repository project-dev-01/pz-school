...
@section('title',' ' .  __('messages.race') . '')
    ...
    <div class="row">
        ...
        <div class="page-title-box" style="display: inline-flex; align-items: center;margin-bottom:5px;margin-top:5px">
                ...
                <ol class="breadcrumb m-0 responsivebc">
                    ...
                    <li class="breadcrumb-item"><a href="javascript: void(0);"> {{ __('messages.race') }}</a></li>
                </ol>
        ...
        <div class="col-lg-12">
            ...
            <ul class="nav nav-tabs" style="display: inline-block;">
                ...
                <div class="form-group pull-right">
                    <div class="">
                        <button type="button" class="btn add-btn btn-rounded waves-effect waves-light" data-toggle="modal" data-target="#addRaceModal">{{ __('messages.add') }}</button>
                    </div>
                </div>
...
<script>
    ...
    // Get PDF Footer Text
    var header_txt="{{ __('messages.race') }}";
