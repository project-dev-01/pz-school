...
@section('title',' ' .  __('messages.staff_position') . '')
    ...
    <div class="row">
        ...
        <div class="page-title-box" style="display: inline-flex; align-items: center;margin-bottom:5px;margin-top:5px">
                ...
                <ol class="breadcrumb m-0 responsivebc">
                    ...
                    <li class="breadcrumb-item"><a href="javascript: void(0);">{{ __('messages.staff_position') }}</a></li>
                </ol>
...
<script>
    ...
    // Get PDF Footer Text
    var header_txt="{{ __('messages.staff_position') }}";
