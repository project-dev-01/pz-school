                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="col-lg-3">
                                    <div class="mt-3">
                                        <input type="file" class="dropify-im" name="photo" id="photo" data-max-file-size="2M" data-plugins="dropify" data-default-file="{{ config('constants.image_url').'/public/common-asset/images/700x500.png' }}" />
