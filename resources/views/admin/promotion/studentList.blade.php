    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-0">
                ...
                <div class="card-body">
                    <form id="promoteDownloadForm" method="post" action="{{ route('admin.promotion.downloadCSV') }}" autocomplete="off">
                        <div class="row">
                            <div class="col-md-3">
                ...
                @endif
                <form id="uploadFile" method="post" enctype="multipart/form-data" action="{{ route('admin.promotion.import.add') }}">
                    {{ csrf_field() }}
    ...
    <div class="row" >
        <div class="col-12">
            <div class="card">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <h4 class="navv">{{ __('messages.promoted_student_list') }}Promoted Student List<h4>
                    </li>
                </ul><br>
                <div class="card-body">
                    <form method="" active="">
...
<script>
    var studentListBulk = "{{ route('admin.promotion.bulk_student_list') }}";
    var getUnassignedStudentList = "{{ route('admin.promotion.unassigned_student_list') }}";
    var getTerminationStudentList = "{{ route('admin.promotion.termination_student_list') }}";
    var promotionImportPreparedUrl = "{{ route('admin.promotion.save_prepared_data') }}";
