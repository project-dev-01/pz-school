    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <h4 class="navv">{{ __('messages.promotion_student_list') }}<h4>
                    </li>
                </ul><br>
                <div class="card-body">
                    <form method="" active="">
...
<script>
    var studentListFreezed = "{{ route('admin.promotion.get_freezed_student_list') }}";
    var studentListUnassignedFreezed = "{{config('constants.api.get_studentList_Unassigned_Freezed')}}"
    var savestatusFreezed = "{{ route('admin.promotion.save_status_freezed_data') }}";
    var promotionFinalData = "{{ route('admin.promotion.promotion_final_data') }}";
    // default image test
