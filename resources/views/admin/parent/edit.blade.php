									...
									<!--<div class="row">
										<div class="col-md-12">
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="form-group mb-3">
														<label for="middle_name">{{ __('messages.middle_name') }}<span class="text-danger">*</span></label>
														<div class="input-group input-group-merge">
															<div class="input-group-prepend">
																<div class="input-group-text">
																	<span class="far fa-user"></span>
															...
															<input type="text" class="form-control" value="{{ isset($parent['middle_name']) ? $parent['middle_name'] : ''}}" name="middle_name" placeholder="{{ __('messages.yamamoto') }}" aria-describedby="inputGroupPrepend">
														</div>
													</div>
												</div>
												<div class="col-md-4">
												...
												<div class="col-md-4">
													<div class="form-group mb-3">
														...
														<div class="input-group input-group-merge">
															...
															<input type="text" name="last_name_furigana" class="form-control alloptions" maxlength="50" id="last_name_furigana"  value="{{ isset($parent['last_name_furigana']) ? $parent['last_name_furigana'] : ''}}" placeholder="{{ __('messages.wick') }}" aria-describedby="inputGroupPrepend">
														</div>
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group mb-3">
														...
														<div class="input-group input-group-merge">
															...
															<input type="text" name="middle_name_furigana" class="form-control alloptions" maxlength="50" id="middle_name_furigana" placeholder="{{ __('messages.wick') }}" aria-describedby="inputGroupPrepend"  value="{{ isset($parent['middle_name_furigana']) ? $parent['middle_name_furigana'] : ''}}">
														</div>
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
														...
														<div class="input-group input-group-merge">
															...
															<input type="text" name="first_name_furigana" class="form-control alloptions" maxlength="50" id="first_name_furigana"  value="{{ isset($parent['first_name_furigana']) ? $parent['first_name_furigana'] : ''}}" placeholder="{{ __('messages.john') }}" aria-describedby="inputGroupPrepend">
														</div>
													</div>
												</div>
											</div>
												...
												<div class="col-md-4">
													<div class="form-group">
														...
														<div class="input-group input-group-merge">
															...
															<input type="text" name="last_name_english" class="form-control alloptions" maxlength="50" id="last_name_english"  value="{{ isset($parent['last_name_english']) ? $parent['last_name_english'] : ''}}" placeholder="{{ __('messages.wick') }}" aria-describedby="inputGroupPrepend">
														</div>
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group mb-3">
														...
														<div class="input-group input-group-merge">
															...
															<input type="text" name="middle_name_english" class="form-control alloptions" maxlength="50" id="middle_name_english" placeholder="{{ __('messages.wick') }}" aria-describedby="inputGroupPrepend" value="{{ isset($parent['middle_name_english']) ? $parent['middle_name_english'] : ''}}">
														</div>
													</div>
												</div>
												<div class="col-md-4">
													<div class="form-group">
														...
														<div class="input-group input-group-merge">
															...
															<input type="text" name="first_name_english" class="form-control alloptions" maxlength="50" id="first_name_english"  value="{{ isset($parent['first_name_english']) ? $parent['first_name_english'] : ''}}" placeholder="{{ __('messages.john') }}" aria-describedby="inputGroupPrepend">
														</div>
													</div>
												</div>
											</div>
											...
											<!--<div class="row">
												...
												<input type="text" class="form-control country" value="{{ isset($parent['country']) ? $parent['country'] : ''}}" name="country" id="country" placeholder="{{ __('messages.country') }}" data-parsley-trigger="change">
												</div>
												</div>
												</div>
												...
												<input type="text" maxlength="50" id="nationality" class="form-control country" placeholder="{{ __('messages.nationality') }}" name="nationality" value="{{ isset($parent['nationality']) ? $parent['nationality'] : ''}}" data-parsley-trigger="change">
												</div>
												</div>
													...
													<div class="form-group">
														...
														<div class="input-group">
															<div class="custom-file">
																...
																<input type="hidden" id="mother_visa_photo_old" value="{{ isset($parent['visa_mother_photo']) ?$parent['visa_mother_photo'] : ''}}" name="mother_visa_photo_old">
