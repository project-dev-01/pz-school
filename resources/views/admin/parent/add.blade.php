								...
								<div id="mother_details">
									...
									<div class="row">
										...
										<!-- @if($form_field['nric'] == 0)
											<div class="col-md-4">
											<div class="form-group">
											<label for="mother_nric">{{ __('messages.nric_number') }}</label>
											<input type="text" maxlength="16" class="form-control" id="mother_nric" name="mother_nric" placeholder="999999-99-9999" data-parsley-trigger="change">
											</div>
											</div>
											@endif
											</div>
											...
											<div class="col-md-4">
											<div class="form-group">
											<label for="mother_passport_number">{{ __('messages.passport_number') }}</label>
											<input type="text" maxlength="20" class="form-control" placeholder="{{ __('messages.enter_passport_number') }}" name="mother_passport_number">
											</div>
											</div>
											<div class="col-md-4">
											...
											<input type="text" class="form-control" id="mother_passport_expiry_date" name="mother_passport_expiry_date" placeholder="{{ __('messages.yyyy_mm_dd') }}" aria-describedby="inputGroupPrepend">
											</div>
											</div>
											</div>
											<div class="col-md-4">
                                            ...
                                            <label class="custom-file-label" for="mother_passport_photo">{{ __('messages.choose_file') }}</label>
											</div>
											</div>
											...
											<div class="col-md-4">
											<div class="form-group">
											<label for="mother_visa_number">{{ __('messages.visa_number') }}</label>
											<input type="text" maxlength="16" id="mother_visa_number" class="form-control alloptions" placeholder="999999-99-9999" name="visa_number" data-parsley-trigger="change">
											</div>
											</div>
											<div class="col-md-4">
											<div class="form-group mb-3">
											...
											<input type="text" class="form-control" id="mother_visa_expiry_date" name="mother_visa_expiry_date" placeholder="{{ __('messages.yyyy_mm_dd') }}" aria-describedby="inputGroupPrepend">
											</div>
											</div>
											</div>
											<div class="col-md-4">
                                            ...
                                            <label class="custom-file-label" for="mother_visa_photo">{{ __('messages.choose_file') }}</label>
											</div>
											</div>
                                        ...
                                        <div id="father_details" >
                                            ...
                                            <div class="row">
												...
												<!--               
													...
													<div class="col-md-4">
													<div class="form-group">
													<label for="father_nric">{{ __('messages.nric_number') }}</label>
													<input type="text" maxlength="16" class="form-control" id="father_nric" name="father_nric" placeholder="999999-99-9999" data-parsley-trigger="change">
													</div>
													</div>
													@endif
													</div>
													...
													<div class="col-md-4">
													<div class="form-group">
													<label for="father_passport_number">{{ __('messages.passport_number') }}</label>
													<input type="text" maxlength="20" class="form-control" placeholder="{{ __('messages.enter_passport_number') }}" name="father_passport_number">
													</div>
													</div>
													<div class="col-md-4">
													<div class="form-group mb-3">
													...
													<input type="text" class="form-control" id="father_passport_expiry_date" name="father_passport_expiry_date" placeholder="{{ __('messages.yyyy_mm_dd') }}" aria-describedby="inputGroupPrepend">
													</div>
													</div>
													</div>
													<div class="col-md-4">
													...
													<label class="custom-file-label" for="father_passport_photo">{{ __('messages.choose_file') }}</label>
													</div>
													</div>
													...
													<div class="col-md-4">
													<div class="form-group">
													<label for="father_visa_number">{{ __('messages.visa_number') }}</label>
													<input type="text" maxlength="16" id="father_visa_number" class="form-control alloptions" placeholder="999999-99-9999" name="father_visa_number" data-parsley-trigger="change">
													</div>
													</div>
													<div class="col-md-4">
													<div class="form-group mb-3">
													...
													<input type="text" class="form-control" id="father_visa_expiry_date" name="father_visa_expiry_date" placeholder="{{ __('messages.yyyy_mm_dd') }}" aria-describedby="inputGroupPrepend">
													</div>
													</div>
													</div>
													<div class="col-md-4">
													...
													<label class="custom-file-label" for="father_visa_photo">{{ __('messages.choose_file') }}</label>
													</div>
													</div>
                                    ...
                                    <ul class="nav nav-tabs">
                                        <li class="nav-item">
											...
											<div class="card-body">
												...
												<div class="row"  style="display:{{ isset($parent['guardian_email']) ? 'none' : ''}}">
													<div class="col-md-4">
														<div class="form-group">
												...
												<!--  <div class="row">
													...
													<div class="col-lg-3">
                                                    <div class="mt-3">
													<input type="file" name="photo" id="photo" class="dropify-im" data-max-file-size="2M" data-plugins="dropify" data-default-file="{{ config('constants.image_url').'/common-asset/images/700x500.png' }}" />
												...
												<div class="row">
													...
													<div class="col-md-4">
														<div class="form-group">
															<label for="guardian_remarks">{{ __('messages.remarks') }}<span class="text-danger">*</span></label>
															<input type="text" class="form-control" id="guardian_remarks"   value="{{ isset($parent['guardian_remarks']) ? $parent['guardian_remarks'] : ''}}" name="guardian_remarks" placeholder="" aria-describedby="inputGroupPrepend">
															<label for="guardian_remarks" class="error"></label>
														</div>
													</div>
												</div>
												<div class="row">
													
													<input type="hidden" name="passport_father_old_photo" id="passport_father_old_photo" value="{{ isset($parent['passport_father_photo']) ? $parent['passport_father_photo'] : ''}}" />
													...
													<div class="col-md-4">
														<div class="form-group">
															...
															<div class="input-group">
																<div class="custom-file">
																	<input type="file" id="passport_father_photo" class="custom-file-input" name="passport_father_photo" accept="image/png, image/gif, image/jpeg"  value="{{ isset($parent['passport_father_photo']) ? $parent['passport_father_photo'] : ''}}">
													...
													<input type="hidden" name="passport_mother_old_photo" id="passport_mother_old_photo" value="{{ isset($parent['passport_mother_photo']) ? $parent['passport_mother_photo'] : ''}}" />
													...
													<input type="hidden" name="visa_father_old_photo" id="visa_father_old_photo" value="{{ isset($parent['visa_father_photo']) ? $parent['visa_father_photo'] : ''}}" />
													...
													<input type="hidden" name="visa_mother_old_photo" id="visa_mother_old_photo" value="{{ isset($parent['visa_mother_photo']) ? $parent['visa_mother_photo'] : ''}}" />
												...
												<li class="nav-item">
													...
													<div class="card-body">
														<div class="row">
															<div class="col-md-4">
																<div class="form-group">
																	<label for="japan_postalcode">{{ __('messages.japan_address_postal') }}</label>
															...
															<div class="col-md-4">
																<div class="form-group">
																	<label for="japan_contact_no">{{ __('messages.japan_contact_phone_number') }}</label>
															...
															<div class="col-md-4">
																<div class="form-group">
																	<label for="japan_emergency_sms">{{ __('messages.Emergency_tel_sms') }}</label>
															...
															<div class="col-md-8">
																<div class="form-group">
																	<label for="japan_addess">{{ __('messages.japan_address') }}</label>
																	<textarea class="form-control" id="japan_addess"    name="japan_addess" placeholder="" aria-describedby="inputGroupPrepend">{{ isset($parent['japan_addess']) ? $parent['japan_addess'] : ''}}</textarea>
																	<label for="japan_addess" class="error"></label>
																</div>
															</div>
															<div class="col-md-4">
																<div class="form-group">
																	<label for="japan_staycategory">{{ __('messages.stay_category') }}</label>
																	<select id="japan_staycategory" name="japan_staycategory" class="form-control">
																		<option value="">{{ __('messages.select_employment_status') }}</option>
																		<option value="Long stay 長期滞在" {{ isset($parent['japan_staycategory']) ? $parent['japan_staycategory'] == "Long stay 長期滞在" ? 'selected' : '' : '' }}>{{ __('messages.long_stay') }}</option>
																		<option value="PR 永住" {{ isset($parent['japan_staycategory']) ? $parent['japan_staycategory'] == "PR 永住" ? 'selected' : '' : '' }}>{{ __('messages.pr_stay') }}</option>
																	</select>
																</div>
															</div>                           
