...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <!--- end row -->
        @include('admin.shortcut_links.add')
        @include('admin.shortcut_links.edit')
    </div>
</div>
<!-- container -->
@endsection
...
<script>
    //bank routes
    var shortcutList = "{{ route('admin.shortcut_link.list') }}";
    var shortcutDetails = "{{ route('admin.shortcut_link.details') }}";
    var shortcutDelete = "{{ route('admin.shortcut_link.delete') }}";
