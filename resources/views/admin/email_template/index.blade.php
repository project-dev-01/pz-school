...
@section('title',' ' .  __('messages.email_template') . '')
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <h4 class="navv">{{ __('messages.email_template') }}
                            <h4>
                    </li>
                </ul><br>
                <div class="form-group pull-right">
                    <div class="col-xs-2 col-sm-2">
                            <a type="button" class="btn add-btn btn-rounded waves-effect waves-light" href="{{ route('admin.email_template.create')}}">{{ __('messages.add') }}</a>
                        <!-- <button type="button" class="btn add-btn btn-rounded waves-effect waves-light" data-toggle="modal" data-target="#addEmailTemplateModal">{{ __('messages.add') }}</button> -->
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table dt-responsive nowrap w-100" id="email-template-table">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>{{ __('messages.email_template') }}</th>
        ...
        <!--- end row -->
        @include('admin.email_template.edit')
    </div>
</div>
<!-- container -->
@endsection
