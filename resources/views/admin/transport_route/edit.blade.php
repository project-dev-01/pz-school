            ...
            <div class="modal-body">
                <form id="edit-transport-route-form" method="post" action="{{ route('admin.transport_route.update') }}" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="name" name="name" class="form-control" placeholder="Enter Route name">
                        <span class="text-danger error-text name_error"></span>
                    </div>
                    <div class="form-group">
                        <label for="start_place">Start Place<span class="text-danger">*</span></label>
                        <input type="text"  name="start_place" class="form-control" placeholder="Enter Start Place">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"  name="stop_place" class="form-control" placeholder="Enter Stop Place">
