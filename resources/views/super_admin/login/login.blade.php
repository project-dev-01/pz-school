...
<body class="loading auth-fluid-pages pb-0">
    <div class="auth-fluid">
        <div class="col-md-6 ">
            <div class="auth-fluid-right text-center superlogin">
                <div class="">
                        ...
                        <div class="form">
                            <form id="LoginAuth" action="{{ route('super_admin.authenticate') }}" method="post">
                                ...
                                <div class="form-group">
                                    <span class="badge badge-secondary smk"><img src="{{ config('constants.image_url').'/public/images/logo-pz-01.png' }}" class="mr-2 rounded-circle" alt="">Paxsuzen</span>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label class="custom-control-label sign" for="checkbox-signin">{{ __('messages.remember_me') }}</label>
                                        <a href="{{route('forgot_password')}}" class="float-right forget"><small>{{ __('messages.forgot_your_password') }}?</small></a>
                                    </div>
                                </div>
