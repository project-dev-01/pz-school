                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control custom-select" name="category" id="event-category" required>
                                                <option value="bg-danger" selected>Book Week Celebration</option>
                                                <option value="bg-success">Teachers' Day</option>
                                                <option value="bg-primary">Sports Day</option>
                                                <option value="bg-info">Scouting Jamboree</option>
                                                <option value="bg-dark">Academic competition</option>
