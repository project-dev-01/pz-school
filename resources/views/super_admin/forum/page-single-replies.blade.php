        ...
        <div class="tt-tab-wrapper">
            <div class="tt-wrapper-inner">
                <ul class="nav nav-tabs pt-tabs-default" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#tt-tab-03" role="tab"><span>{{ __('messages.replies') }}</span></a>
                    </li>
                ...
                <div class="tab-pane" id="tt-tab-06" role="tabpanel">
                    ...
                    <div class="tt-item">
                        <div class="tt-item-header">
                            ...
                            <h6 class="tt-title"><a href="{{ route('super_admin.forum.page-categories-single') }}">{{ __('messages.threads') }} - 98</a></h6>
                        </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="tt-item">
                        <div class="tt-item-header">
                            ...
                            <h6 class="tt-title"><a href="{{ route('super_admin.forum.page-categories-single') }}">{{ __('messages.threads') }} - 28</a></h6>
                        </div>
                        <div class="tt-item-layout">
                            <div class="tt-innerwrapper">
                                Exam tips and preparations... the do's and don'ts of surviving exam period
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="tt-item">
                        <div class="tt-item-header">
                            ...
                            <h6 class="tt-title"><a href="{{ route('super_admin.forum.page-categories-single') }}">{{ __('messages.threads') }} - 74</a></h6>
                        </div>
                        <div class="tt-item-layout">
                            <div class="tt-innerwrapper">
                            Best Foreign Languge to Study?
