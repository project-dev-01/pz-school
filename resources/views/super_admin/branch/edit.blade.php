                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="location" id="location" value="{{$branch['location']}}" placeholder="{{ __('messages.location') }}">
                                </div>
                            </div>
                        </div>
                    </div>
...
<script src="{{ asset('public/js/custom/branchs.js') }}"></script>
@endsection