                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" autocomplete="off" name="frm_ldate" class="form-control datepickerss" id="editfrm_ldate" placeholder="{{ __('messages.dd_mm_yyyy') }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" autocomplete="off" name="to_ldate" class="form-control datepickerss" id="editto_ldate" placeholder="{{ __('messages.dd_mm_yyyy') }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
