    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box" style="display: inline-flex; align-items: center;">
                ...
                <h4 class="page-title" style="margin-left: 10px;">{{ __('messages.event') }}</h4>
            </div>
        </div>
    </div>
