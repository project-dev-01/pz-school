                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered mb-0 table2excel" style="width:max-content;">
                                    <tbody id="timetable">
                                        ...
                                        <tr>
                                            <td class="center" style="color:#ed1833;">{{ __('messages.day') }}/{{ __('messages.period') }}</td>
                                            @for ($i = 1; $i <= $max; $i++) <td class="centre">{{ $i }}</td>
                                                @endfor
                                        </tr>
                                        @foreach($days as $day)
