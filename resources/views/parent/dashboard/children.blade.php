                    ...
                    <div class="col-md-3">
                        <div class="tab-content pt-0">
                            <div class="tab-pane active show" id="product-1-item">
                                <img src="{{ config('constants.image_url').'/public/common-asset/images/users/user-12.jpg' }}" alt="" style="width:100%" class="img-fluid mx-auto d-block rounded">
                            </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="tab-content pt-0">
                            <div class="tab-pane active show" >
                                <img src="{{ config('constants.image_url').'/public/common-asset/images/users/user-13.jpg' }}" alt="" style="width:100%" class="img-fluid mx-auto d-block rounded">
                            </div>
                        </div>
                    </div> <!-- end col -->
                    <div class="col-lg-7">
