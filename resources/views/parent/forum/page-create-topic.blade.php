...
<main id="tt-pageContent">
    <div class="container card" style="background:white;">
        <div class="tt-wrapper-inner" id="createpostForumreset">
            ...
            <form class="form-default form-create-topic" id="createpostForum" method="post" action="{{ route('parent.forum.create-topic') }}" autocomplete="off">
                @csrf
                ...
                <div class="tt-item">
                    ...
                    <div class="tt-col-value" style="padding-right: 0px;padding-left: 0px;">
                        <div class="button-list">
                            <a href="{{route('parent.forum.page-edit-topic', $value['id'])}}" class="btn btn-blue waves-effect waves-light"><span class=""><i class="mdi mdi-square-edit-outline"></i></span></a>
...
<script>
    class MyUploadAdapter {
        ...
        _initRequest() {
            ...
            // could be different.
            xhr.open('POST', "{{ route('parent.forum.image.store') }}", true);
