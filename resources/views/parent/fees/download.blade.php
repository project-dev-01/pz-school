            ...
            <tr>
              <td class="content-wrap">
                <table width="100%">
                  ...
                  <tr>
                    <td>
                      <img src="{{ config('constants.image_url').'/public/common-asset/images/'}}" class="mr-2 rounded-circle" alt="">
                      <h3 class="invoice">{{ __('messages.invoice') }}</h3>
                      <p class="schoolname" >{{ $school_name }}</p>
                    </td>
                  </tr>
                  <tr>
                    <td width="50%">
                          <p><b>{{ __('messages.to') }}: {{ $parent['first_name'] }} {{ $parent['last_name'] }}</b></p>
                          <div class="mt-3" style="line-height: 10px;">
                            <p>S{{ $parent['address'] }}{{ $school_name }},</p>
                    ...
                    <td width="25%">
                          <h4>{{ __('messages.invoice_date') }} </h4>
                          <div class="mt-3" style="line-height: 10px;">
                            <p class="m-b-10"><strong>{{ __('messages.invoice_date') }}  : </strong></p>
                            <p class="m-b-10"><strong>{{ __('messages.due_date') }} : </strong> </p>
                            <p class="m-b-10"><strong>{{ __('messages.invoice_no') }}  : </strong> </p>
                          </div>
                    </td>
                    <td width="25%">
                          <h4 style="visibility: hidden">.</h4>
                          <div class="mt-3" style="line-height: 10px;">
                            <p class="m-b-10"><span>{{$date}}</span></p>
                            <p class="m-b-10"><span></span></p>
                            <p class="m-b-10"><span></span></p>
                          </div>
                    </td>
                  </tr>
                ...
                <table class="table mt-2 table-centered">
                  <thead>
                    <tr>
                      ...
                      <th style="width: 10%"><b>{{ __('messages.paid') }}</b></th>
                ...
                <table>
                  <tbody>
                    <tr>
                      ...
                      <td width="25%">
                              <p><b>{{ __('messages.total') }} :</b> </p>
                      </td>
                      <td width="25%">
                              <p><span><b>${{$total_balance - $total_fine}}</b></span></p>
                      </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        ...
                        <td class="float-right">{{ $school_name }}
                        </td>
