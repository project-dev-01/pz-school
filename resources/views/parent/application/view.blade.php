                                ...
                                <div class="table-responsive"  style="background-color: #8adfee14;">
                                    <table class="table w-100 nowrap">
                                        ...
                                        <tr>
                                            ...
                                            <td class="academic_year">2023 - 2024</td>
                                        </tr>
                                        <tr>
                                            <td>{{ __('messages.grade') }}</td>
                                            <td class="academic_grade">2年</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="email">seyon@gmail.com</td>
                                        </tr>
                                        <tr>
                                            <td>{{ __('messages.address_1') }}</td>
                                            <td class="address_1">No 32 Main Street</td>
                                        </tr>
                                        <tr>
                                            <td>{{ __('messages.address_2') }}</td>
                                            <td class="address_2">Johor Bahru</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="state">Johor</td>
                                        </tr>
                                        <tr>
                                            <td>{{ __('messages.city') }}</td>
                                            <td class="city">Johor Bahru</td>
                                        </tr>
                                        <tr>
