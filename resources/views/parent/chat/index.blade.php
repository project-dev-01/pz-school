            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="media mb-3">
                        <img src="{{ asset('public/images/users/user-5.jpg') }}" class="mr-2 rounded-circle" height="42" alt="Brandon Smith">
            ...
            <div class="card">
                <div class="card-body py-2 px-3 border-bottom border-light">
                    <div class="media py-1">
                        <img src="{{ asset('public/images/users/user-1.jpg') }}" class="mr-2 rounded-circle" height="36" alt="Brandon Smith">
                        <div class="media-body">
                            <h5 class="mt-0 mb-0 font-15">
                    ...
                    <ul class="conversation-list" data-simplebar style="max-height: 460px">
                        ...
                        <li class="clearfix odd">
                            <div class="chat-avatar">
                                <img src="{{ asset('public/images/users/user-5.jpg') }}" class="rounded" alt="James Z" />
                                <i>10:01</i>
                            </div>
                        ...
                        <li class="clearfix">
                            <div class="chat-avatar">
                                <img src="{{ asset('public/images/users/user-1.jpg') }}" class="rounded" alt="Geneva M" />
                                <i>10:00</i>
                            </div>
                            <div class="conversation-text">
                                <div class="ctext-wrap">
