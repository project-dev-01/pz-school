        ...
        <div class="tt-tab-wrapper">
            <div class="tt-wrapper-inner">
                <ul class="nav nav-tabs pt-tabs-default" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#tt-tab-01" role="tab"><span>{{ __('messages.about') }}</span></a>
                    </li>
                    <li class="nav-item show">
                        <a class="nav-link active" data-toggle="tab" href="#tt-tab-02" role="tab"><span>{{ __('messages.guidelines') }}</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#tt-tab-03" role="tab"><span>{{ __('messages.faq') }}</span></a>
                    </li>
                    <li class="nav-item tt-hide-xs">
                        <a class="nav-link" data-toggle="tab" href="#tt-tab-04" role="tab"><span>{{ __('messages.terms_of_services') }}</span></a>
                    </li>
