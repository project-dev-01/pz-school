        ...
        <div class="col-12">
            <div class="page-title-box" style="display: inline-flex; align-items: center;">
                ...
                <ol class="breadcrumb m-0 responsivebc">
						...
						<li class="breadcrumb-item"><a href="javascript: void(0);">{{ __('messages.general_settings') }}</a></li>
					</ol>           
                </div>
        </div>
    </div>
            ...
            <div class="card-box">
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="settings">
                        <form method="POST" action="{{ route('teacher.settings.updateProfileInfo') }}" id="updateProfileInfo">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea type="textarea" class="form-control" name="present_address" rows="4" id="present_address">{{ isset($user_details['present_address']) ? $user_details['present_address'] : ''}}</textarea>
...
<script src="{{ asset('js/custom/admin_settings.js') }}"></script>
@endsection