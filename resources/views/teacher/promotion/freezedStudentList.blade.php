...
@section('title',' ' . __('messages.promotion_freezed') . '')
			...
			<div class="col-12">
				<div class="page-title-box" style="display: inline-flex; align-items: center;">
					...
					<ol class="breadcrumb m-0 responsivebc">
						...
						<li class="breadcrumb-item"><a href="javascript: void(0);">{{ __('messages.promotion_freezed') }}</a></li>
					</ol>
...
<script src="{{ asset('js/custom/promotion_bulk_process.js') }}"></script>
