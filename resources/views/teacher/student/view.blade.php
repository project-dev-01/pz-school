            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="collapse" id="basic_detail">
                        <form id="editadmission" method="post" action="" enctype="multipart/form-data" autocomplete="off">
                            @csrf
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input type="text" name="fname" class="form-control" value="{{ isset($student['first_name']) ? $student['first_name'] : ''}}" id="fname" placeholder="" aria-describedby="inputGroupPrepend">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input type="text" name="lname" class="form-control" id="lname" value="{{ isset($student['last_name']) ? $student['last_name'] : ''}}" placeholder="" aria-describedby="inputGroupPrepend">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input type="text" name="dob" class="form-control" value="{{ isset($student['birthday']) ? $student['birthday'] : ''}}" id="dob" placeholder="" aria-describedby="inputGroupPrepend">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" maxlength="50" id="txt_nric" class="form-control alloptions" value="{{ isset($student['nric']) ? $student['nric'] : ''}}" placeholder="{{ __('messages.enter_nric_number') }}" name="txt_nric" data-parsley-trigger="change">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="tel" class="form-control" name="txt_mobile_no" id="txt_mobile_no" value="{{ isset($student['mobile_no']) ? $student['mobile_no'] : ''}}" data-parsley-trigger="change">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="drp_country">{{ __('messages.country') }}</label>
                                                <input type="" id="drp_country" class="form-control" name="drp_country" data-parsley-trigger="change" value="{{ isset($student['country']) ? $student['country'] : ''}}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="drp_state">{{ __('messages.state_province') }}</label>
                                                <input type="" id="drp_state" class="form-control" name="drp_state" data-parsley-trigger="change" value="{{ isset($student['state']) ? $student['state'] : ''}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="" id="drp_city" class="form-control" name="drp_city" data-parsley-trigger="change" value="{{ isset($student['city']) ? $student['city'] : ''}}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="drp_post_code">{{ __('messages.zip_postal_code') }}</label>
                                                <input type="" id="drp_post_code" class="form-control" name="drp_post_code" data-parsley-trigger="change" value="{{ isset($student['post_code']) ? $student['post_code'] : ''}}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="txtarea_paddress">{{ __('messages.address_1') }}</label>
                                                <input type="" id="txtarea_paddress" class="form-control" name="txtarea_paddress" data-parsley-trigger="change" value="{{ isset($student['current_address']) ? $student['current_address'] : ''}}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label for="txtarea_permanent_address">{{ __('messages.address_2') }}</label>
                                                <input type="" id="txtarea_permanent_address" class="form-control" name="txtarea_permanent_address" data-parsley-trigger="change" value="{{ isset($student['permanent_address']) ? $student['permanent_address'] : ''}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select id="btwyears" class="form-control" name="year">
                                                    <option {{isset($student['year']) ? $student['year'] == "2021-2022" ? "Selected" : "" : "" }}>2021-2022</option>
                                                    <option {{isset($student['year']) ? $student['year'] == "2020-2021" ? "Selected" : "" : "" }}>2020-2021</option>
                                                    <option {{isset($student['year']) ? $student['year'] == "2019-2020" ? "Selected" : "" : "" }}>2019-2020</option>
                                                    <option {{isset($student['year']) ? $student['year'] == "2018-2019" ? "Selected" : "" : "" }}>2018-2019</option>
                                                    <option {{isset($student['year']) ? $student['year'] == "2017-2018" ? "Selected" : "" : "" }}>2017-2018</option>
                                                    <option {{isset($student['year']) ? $student['year'] == "2016-2017" ? "Selected" : "" : "" }}>2016-2017</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group mb-3">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input type="text" class="form-control" id="admission_date" value="{{ isset($student['admission_date']) ? $student['admission_date'] : ''}}" name="admission_date" placeholder="" aria-describedby="inputGroupPrepend">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select id="categy" name="categy" class="form-control">
                                                    ...
                                                    <option value="2" {{isset($student['category_id']) ? $student['category_id'] == 2 ? "Selected" : "" : "" }}>Two</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    ...
                                                    <input type="text" name="txt_emailid" class="form-control" id="txt_emailid" placeholder="" aria-describedby="inputGroupPrepend" value="{{ isset($student['email']) ? $student['email'] : ''}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="relation">
                                                    ...
                                                    <option value="{{$r['id']}}" {{isset($student['relation']) ? $student['relation'] == $r['id'] ? "selected" : "" : "" }}>{{$r['name']}}</option>
                                                    @empty
                                                    @endforelse
                                                </select>
                                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="drp_transport_vechicleno">{{ __('messages.vechicle_no') }}</label>
                                                <select id="drp_transport_vechicleno" name="drp_transport_vechicleno" class="form-control">
                                                    <option value="">{{ __('messages.first_select_the_transport') }}</option>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="txt_prev_schname">{{ __('messages.school_names') }}</label>
                                                <input type="text" id="txt_prev_schname" class="form-control" name="txt_prev_schname" data-parsley-trigger="change" value="{{ isset($student['school_name']) ? $student['school_name'] : ''}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="txt_prev_qualify">{{ __('messages.qualification') }}</label>
                                                <input type="text" id="txt_prev_qualify" class="form-control" name="txt_prev_qualify" data-parsley-trigger="change" value="{{ isset($student['qualification']) ? $student['qualification'] : ''}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="txtarea_prev_remarks">{{ __('messages.remarks') }}</label>
                                                <textarea id="txtarea_prev_remarks" class="form-control" name="txtarea_prev_remarks">{{ isset($student['remarks']) ? $student['remarks'] : ''}}
                                                </textarea>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="form-group text-right m-b-0">
                                ...
                                <a href="{{ route('teacher.student.index') }}" class="btn btn-primary-bl waves-effect waves-light">
                                {{ __('messages.back') }}
                                </a>
