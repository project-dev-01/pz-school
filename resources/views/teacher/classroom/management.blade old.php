                ...
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <ul class="nav nav-tabs nav-bordered">
                            ...
                            <li class="nav-item">
                                <a href="#shortest" data-toggle="tab" aria-expanded="false" class="navv">
                                    Short Test
                                </a>
                            </li>
                            <li class="nav-item">
                                ...
                                <div class="tab-pane" id="home-b1">
                                    <form id="addListMode" method="post" action="{{ route('teacher.classroom.add') }}" autocomplete="off">
                                        ...
                                        <div class="col-md-12">
                                            <div class="table-responsive">
                                                ...
                                                <table id="listModeClassRoom" class="table" width="100%">
                                    ...
                                    <form id="updatestudentleave" method="post" action="{{ route('teacher.studentleave.update') }}" autocomplete="off">
                                        <div class="col-md-12">
                                            ...
                                            <div class="table-responsive">
                                                <table id="stdleaves" class="table" width="100%">
                                                    <thead>
                                                        <tr>
                                                            <th>#</th>
                                                            <th>Student name</th>
