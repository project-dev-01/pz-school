                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="text-center">
                                                            <a href="javascript:void(0)"><i class="fas fa-star" style="font-size:20px;color: #0ABAB5"></i></a>
                                                            <a href="javascript:void(0)"><i class="fas fa-star" style="font-size:20px;color: #0ABAB5"></i></a>
                                                            <a href="javascript:void(0)"><i class="fas fa-star" style="font-size:20px;color: #0ABAB5"></i></a>
                                                            <a href="javascript:void(0)"><i class="fas fa-star" style="font-size:20px;color: #0ABAB5"></i></a>
                                                            <a href="javascript:void(0)"><i class="fas fa-star" style="font-size:20px;color: #0ABAB5"></i></a>
                                                    ...
                                                    <td>
                                                        <div class="text-center">
                                                            <a href="javascript:void(0)"><i class=' far fa-thumbs-up' style='font-size:20px;color:blue'></i></a>
                                                            <a href="javascript:void(0)"><i class='far fa-thumbs-down' style='font-size:20px;color:red'></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <!-- <tr>
