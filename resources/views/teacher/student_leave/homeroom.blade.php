<div class="modal fade DetailsModal" id="homeRoomPopup" tabindex="-1" role="dialog" aria-labelledby="DetailsModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="DetailsModalTitle">Class Incharge Teacher</h5>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <select id="leave_status_name" name="leave_status_name" class="form-control">
                                        ...
                                        <option value="Approve" selected>{{ __('messages.approve') }}</option>
