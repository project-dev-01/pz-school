...
<head>
    ...
    <link href="{{ asset('full-calendor/lib/main.css') }}" rel="stylesheet" />
    <!-- <link href="{{ asset('css/fullcalendar/fullcalendar.css') }}" rel="stylesheet" type="text/css" id="bs-default-stylesheet" /> -->
