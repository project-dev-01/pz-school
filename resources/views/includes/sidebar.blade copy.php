            ...
            <ul id="side-menu">
                ...
                <li>
                    <a href="#sidebarmenu" data-toggle="collapse">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#C4C7D2" viewBox="0 0 50 50" width="50px" height="50px">
                ...
                <li>
                    <a href="{{ route('super_admin.forum.rolls-chooseforum')}}" class="nav-link {{ (request()->is('super_admin/forum*')) ? 'active' : '' }}">
                        <svg width="20" height="20" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarLeaveManage">
                        <ul class="nav-second-level">
                            ...
                            <li>
                                <a href="{{ route('admin.leave_management.leave_history_by_staff')}}" class="nav-link {{ (request()->is('admin/leave_management/leave_history_by_staff')) ? 'active' : '' }}">
                                    <span> {{ __('messages.leave_history_by_staff') }} </span>
                                </a>
                            </li>
                            <li>
                ...
                <li>
                    <a href="#sidebarAdminChildHealth" data-toggle="collapse">
                        ...
                        <span>{{ __('messages.child_health') }}</span>
                        <span class="menu-arrow"></span>
                    </a>
                    <div class="collapse" id="sidebarAdminChildHealth">
                        <ul class="nav-second-level">
                            ...
                            <li>
                                <a href="{{ route('admin.child_health.index')}}" class="nav-link {{ (request()->is('admin/child_health/index') || request()->is('admin/employee/edit*')) ? 'active' : '' }}">
                ...
                <li>
                    ...
                    <div class="collapse" id="sidebarMultilevel">
                        <ul class="nav-second-level">
                            ...
                            <li>
                                <a href="{{ route('admin.exam.import')}}" class="nav-link {{ (request()->is('admin/test_result*')) ? 'active' : '' }}">
                                    <span>{{ __('messages.exam_import') }}</span>
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <div class="collapse" id="sidebarResult">
                                    <ul class="nav-second-level">
                                        <li>
                                            <a href="{{ route('admin.exam_results.byreport')}}" class="nav-link {{ (request()->is('admin/exam_results')) ? 'active' : '' }}">
                                                <span>{{ __('messages.export_examresult') }}</span>
                                            </a>
                                        </li>
                                        <li>
                ...
                <li class="{{  (request()->is('admin/fees_group*') || request()->is('admin/fees/edit*')) ? 'menuitem-active' : '' }}">
                    ...
                    <div class="collapse {{  (request()->is('admin/fees_group*') || request()->is('admin/fees/edit*')) ? 'show' : '' }}" id="sidebarFees">
                        <ul class="nav-second-level">
                            ...
                            <li>
                                <a href="{{ route('admin.fees.expense.index')}}" class="nav-link {{ (request()->is('admin/fees/import/expense/index')) ? 'active' : '' }}">
                                    <span>{{ __('messages.expense_list') }}</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.fees.import')}}" class="nav-link {{ (request()->is('admin/fees/import/expense')) ? 'active' : '' }}">
                ...
                <li class="{{  (request()->is('admin/group*') || request()->is('admin/hostel_group*') || request()->is('admin/bank_account*')) ? 'menuitem-active' : '' }}">
                    ...
                    <div class="collapse {{  (request()->is('admin/group*') || request()->is('admin/hostel_group*') || request()->is('admin/bank_account*'))  ? 'show' : '' }}" id="sideBarSettings">
                        <ul class="nav-second-level">
                            <li>
                            ...
                            <li>
                                <a href="{{ route('admin.bank')}}" class="nav-link {{ (request()->is('admin/bank/*')) ? 'active' : '' }}">
                                    <span> {{ __('messages.bank') }} </span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.bank_account')}}" class="nav-link {{ (request()->is('admin/bank_account*')) ? 'active' : '' }}">
                                    <span> {{ __('messages.bank_account') }} </span>
                                </a>
                            </li>
                            <li>
                ...
                <li>
                    <a href="{{ route('staff.forum.index')}}" class="nav-link {{ (request()->is('staff/forum*')) ? 'active' : '' }}">
                        <svg width="20" height="20" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M15.7502 9.30668C17.8006 11.08 18.5614 13.3232 18.0297 16.063L18.1258 16.1133C18.7084 16.3704 19.291 16.6246 19.8708 16.8876C19.9065 16.9085 19.9482 16.9152 19.9882 16.9065C20.0282 16.8978 20.0638 16.8743 20.0886 16.8403C20.3797 16.5337 20.7448 16.3154 21.1452 16.2084C21.5456 16.1015 21.9663 16.1101 22.3624 16.2332C22.7585 16.3563 23.1153 16.5894 23.3947 16.9
364 2.30936C7.83807 2.16555 8.28329 2.14901 8.70646 2.26169C9.12962 2.37436 9.51295 2.61154 9.81099 2.94507C10.109 3.2786 10.3093 3.69448 10.3879 4.14336C10.464 4.52537 10.4449 4.92139 10.3324 5.29348C10.22 5.66557 10.0181 6.00126 9.74591 6.26839C9.70851 6.29789 9.68309 6.34102 9.67471 6.3892C9.66633 6.43739 9.67559 6.4871 9.70067 6.52848C9.92127 7.06934 10.1334 7.61316 10.3512 8.15402C10.3653 8.19244 10.3851 8.23086 10.4077 8.28111C11.7676 7.88531 13.2163 7.98965 14.5114 8.57666L16.5958 4.79653C16.2104 4.35192 16.0011 3.77083 16.0104 3.17099C16.0171 2.83804 16.0903 2.51023 16.2254 2.20858C16.3604 1.90692 16.5542 1.63807 16.7944 1.41925C17.0347 1.20042 17.316 1.03645 17.6204 0.937846C17.9248 0.839238 18.2455 0.808167 18.562 0.846622C18.8786 0.885077 19.184 0.992209 19.4586 1.16116C19.7332 1.33011 19.971 1.55714 20.1568 1.82772C20.3426 2.0983 20.4722 2.40645 20.5374 2.73243C20.6026 3.05841 20.602 3.39503 20.5355 3.72072C20.4204 4.27722 20.117 4.77163 19.6811 5.11315C19.2452 5.45467 18.706 5.62035 18.1626 5.57975C18.0578 5.55534 17.9482 5.57195 17.8543 5.62642C17.7605 5.68089 17.689 5.76945 17.6535 5.8753C17.0624 6.97772 16.4516 8.06831 15.8491 9.16481C15.8039 9.20324 15.7756 9.25939 15.7502 9.30668Z" fill="#C4C7D2" />
                        </svg>
                        <span>{{ __('messages.forum') }}</span>
                ...
                <!-- <li>
                    <a href="{{ route('staff.clear_local_storage')}}" class="nav-link {{ (request()->is('staff/clear_local_storage')) ? 'active' : '' }}">
                ...
                <!-- <li>
                    <a href="{{ route('schoolcrm.app.form')}}" class="nav-link {{ (request()->is('application-form')) ? 'active' : '' }}">
                ...
                <li>
                    <a href="{{ route('teacher.forum.index')}}" class="nav-link {{ (request()->is('teacher/forum*')) ? 'active' : '' }}">
                ...
                <li>
                    ...
                    <div id="sideBarSettings">
                        <ul class="nav-second-level">
                            ...
                            <li>
                                <a href="{{ route('teacher.dashboard.widget')}}" class="nav-link {{ (request()->is('teacher/dashboard/widget*')) ? 'active' : '' }}">
                                    <span> {{ __('messages.dashboard_hideunhide') }} </span>
                                </a>
                            </li>
                            <li>
                ...
                <li>
                    <a href="{{ route('parent.buletin_board')}}" class="nav-link {{ (request()->is('parent/buletin_board*')) ? 'active' : '' }}">
                        <!--<i class="far fa-comments"></i>--->
                        <svg class="svg-icon responsiveicon" style="vertical-align: middle;fill: currentColor;overflow: hidden;" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
                            <path d="M513.706667 106.666667L406.613333 213.333333h213.333334l-106.24-106.666666M170.666667 298.666667v554.666666h682.666666V298.666667H170.666667m341.333333-298.666667l213.333333 213.333333h128a85.333333 85.333333 0 0 1 85.333334 85.333334v554.666666a85.333333 85.333333 0 0 1-85.333334 85.333334H170.666667a85.333333 85.333333 0 0 1-85.333334-85.333334V298.666667a85.333333 85.333333 0 0 1 85.333334-85.333334h128l213.333333-213.333333M298.666667 768v-170.666667h213.333333v170.666667H298.666667m298.666666-42.666667v-298.666666h170.666667v298.666666h-170.666667m-341.333333-213.333333V384h213.333333v128H256z" fill="#C4C7D2" />
                        </svg>
                        <span> {{ __('messages.buletin') }} </span>
                    </a>
                ...
                <li>
                    <a href="#sidebarParentTermination" data-toggle="collapse">
                        <svg width="800px" height="800px" viewBox="0 0 48 48" fill="#C4C7D2" xmlns="http://www.w3.org/2000/svg">
                            <path d="M40 16.3977V6C40 4.89543 39.1046 4 38 4H10C8.89543 4 8 4.89543 8 6V42C8 43.1046 8.89543 44 10 44H20" stroke="#C4C7D2" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M16 14H29" stroke="#C4C7D2" stroke-width="4" stroke-linecap="round" />
                            <path d="M16 21H21" stroke="#C4C7D2" stroke-width="4" stroke-linecap="round" />
                            <path d="M34 44C28.4772 44 24 39.5228 24 34C24 28.4772 28.4772 24 34 24C39.5228 24 44 28.4772 44 34C44 39.5228 39.5228 44 34 44Z" stroke="#C4C7D2" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
                ...
                <!-- <li>
                    <a href="{{ route('parent.clear_local_storage')}}" class="nav-link {{ (request()->is('parent/clear_local_storage')) ? 'active' : '' }}">
                        <svg class="svg-icon responsiveicon" style="vertical-align: middle;fill: currentColor;overflow: hidden;" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
                            <path d="M837.818182 915.549091h-131.956364c-12.8 0-23.272727-10.472727-23.272727-23.272727v-58.181819c0-4.189091-8.843636-11.636364-23.272727-11.636363s-23.272727 7.447273-23.272728 11.636363v58.181819c0 12.8-10.472727 23.272727-23.272727 23.272727H465.454545c-12.8 0-23.272727-10.472727-23.272727-23.272727s10.472727-23.272727 23.272727-23.272728h124.043637v-34.909091c0-32.581818 30.72-58.181818 69.818182-58.181818s69.818182 25.6 69.818181 58.181818v34.909091H814.545455v-232.727272H209.454545v232.727272h93.789091c12.8 0 23.272727 10.472727 23.272728 23.272728s-10.472727 23.272727-23.272728 23.272727H186.181818c-12.8 0-23.272727-10.472727-23.272727-23.272727v-279.272728c0-12.8 10.472727-23.272727 23.272727-23.272727h651.636364c12.8 0 23.272727 10.472727 23.272727 23.272727v279.272728c0 12.8-10.472727 23.272727-23.272727 23.272727z" fill="#FFFFFF" />
                            <path d="M837.818182 636.276364H186.181818c-12.8 0-23.272727-10.472727-23.272727-23.272728v-69.818181c0-11.403636 8.145455-20.945455 19.316364-22.807273l244.596363-43.054546V124.276364c0-26.065455 23.970909-46.545455 54.225455-46.545455h62.138182c30.487273 0 54.225455 20.48 54.225454 46.545455V477.090909l244.596364 43.054546c11.170909 1.861818 19.316364 11.636364 19.316363 22.807272v69.818182A23.738182 23.738182 0 0 1 837.818182 636.276364z m-628.363637-46.545455h605.09091v-26.996364l-244.596364-43.054545a23.202909 23.202909 0 0 1-19.316364-22.807273V126.138182a13.172364 13.172364 0 0 0-7.68-2.094546h-62.138182c-3.723636 0-6.516364 1.163636-7.68 2.094546v370.269091c0 11.403636-8.145455 20.945455-19.316363 22.807272L209.454545 562.734545v26.996364z" fill="#FFFFFF" />
                        </svg>
                ...
                <li>
                    <a href="{{ route('parent.forum.index')}}" class="nav-link {{ (request()->is('parent/forum*')) ? 'active' : '' }}">
                        <svg width="20" height="20" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M15
.21021 6.95703C7.77372 6.97049 7.3427 6.8528 6.96829 6.61795C6.59388 6.38309 6.29179 6.04091 6.09789 5.63203C5.90399 5.22314 5.82641 4.7647 5.87435 4.31111C5.92229 3.85753 6.09373 3.42784 6.36835 3.07302C6.64297 2.71821 7.00921 2.45317 7.42364 2.30936C7.83807 2.16555 8.28329 2.14901 8.70646 2.26169C9.12962 2.37436 9.51295 2.61154 9.81099 2.94507C10.109 3.2786 10.3093 3.69448 10.3879 4.14336C10.464 4.52537 10.4449 4.92139 10.3324 5.29348C10.22 5.66557 10.0181 6.00126 9.74591 6.26839C9.70851 6.29789 9.68309 6.34102 9.67471 6.3892C9.66633 6.43739 9.67559 6.4871 9.70067 6.52848C9.92127 7.06934 10.1334 7.61316 10.3512 8.15402C10.3653 8.19244 10.3851 8.23086 10.4077 8.28111C11.7676 7.88531 13.2163 7.98965 14.5114 8.57666L16.5958 4.79653C16.2104 4.35192 16.0011 3.77083 16.0104 3.17099C16.0171 2.83804 16.0903 2.51023 16.2254 2.20858C16.3604 1.90692 16.5542 1.63807 16.7944 1.41925C17.0347 1.20042 17.316 1.03645 17.6204 0.937846C17.9248 0.839238 18.2455 0.808167 18.562 0.846622C18.8786 0.885077 19.184 0.992209 19.4586 1.16116C19.7332 1.33011 19.971 1.55714 20.1568 1.82772C20.3426 2.0983 20.4722 2.40645 20.5374 2.73243C20.6026 3.05841 20.602 3.39503 20.5355 3.72072C20.4204 4.27722 20.117 4.77163 19.6811 5.11315C19.2452 5.45467 18.706 5.62035 18.1626 5.57975C18.0578 5.55534 17.9482 5.57195 17.8543 5.62642C17.7605 5.68089 17.689 5.76945 17.6535 5.8753C17.0624 6.97772 16.4516 8.06831 15.8491 9.16481C15.8039 9.20324 15.7756 9.25939 15.7502 9.30668Z" fill="#C4C7D2" />
                        </svg>
                        <span>{{ __('messages.forum') }}</span>
                ...
                <li>
                    <a href="{{ route('student.forum.index')}}" class="nav-link {{ (request()->is('student/forum*')) ? 'active' : '' }}">
                        <svg width="20" height="20" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M15.7502 9.30668C17.8006 11.08 18.5614 13.3232 18.0297 16.063L18.1258 16.1133C18.7084 16.3704 19.291 16.6246 19.8708 16.8876C19.9065 16.9085 19.9482 16.9152 19.9882 16.9065C20.0282 16.8978 20.0638 16.8743 20.0886 16.8403C20.3797 16.5337 20.7448 16.3154 21.1452 16.2084C21.5456 16.1015 21.9663 16.1101 22.3624 16.2332C22.7585 16.3563 23.1153 16.5894 23.3947 16.9076C23.6741 17.2259 23.8657 17.6173 23.9491 18.0403C24.012 18.3706 24.0073 18.7111 23.9353 19.0394C23.8634 19.3677 23.7258 19.6763 23.5316 19.9451C23.3374 20.2139 23.091 20.4367 22.8086 20.599C22.5262 20.7612 22.2141 20.8591 21.8929 20.8864C21.5717 20.9137 21.2486 20.8697 20.9448 20.7572C20.641 20.6447 20.3634 20.4664 20.1303 20.2339C19.8971 20.0014 19.7136 19.72 19.5919 19.4082C19.4702 19.0963 19.413 18.7611 19.424 18.4
 10.4077 8.28111C11.7676 7.88531 13.2163 7.98965 14.5114 8.57666L16.5958 4.79653C16.2104 4.35192 16.0011 3.77083 16.0104 3.17099C16.0171 2.83804 16.0903 2.51023 16.2254 2.20858C16.3604 1.90692 16.5542 1.63807 16.7944 1.41925C17.0347 1.20042 17.316 1.03645 17.6204 0.937846C17.9248 0.839238 18.2455 0.808167 18.562 0.846622C18.8786 0.885077 19.184 0.992209 19.4586 1.16116C19.7332 1.33011 19.971 1.55714 20.1568 1.82772C20.3426 2.0983 20.4722 2.40645 20.5374 2.73243C20.6026 3.05841 20.602 3.39503 20.5355 3.72072C20.4204 4.27722 20.117 4.77163 19.6811 5.11315C19.2452 5.45467 18.706 5.62035 18.1626 5.57975C18.0578 5.55534 17.9482 5.57195 17.8543 5.62642C17.7605 5.68089 17.689 5.76945 17.6535 5.8753C17.0624 6.97772 16.4516 8.06831 15.8491 9.16481C15.8039 9.20324 15.7756 9.25939 15.7502 9.30668Z" fill="#C4C7D2" />
                        </svg>
                        <span>{{ __('messages.forum') }}</span>
                ...
                <!-- <li>
                    <a href="{{ route('student.clear_local_storage')}}" class="nav-link {{ (request()->is('student/clear_local_storage')) ? 'active' : '' }}">
                        <svg class="svg-icon" style="width: 15; height: 20;vertical-align: middle;fill: currentColor;overflow: hidden;" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
                            <path d="M837.818182 915.549091h-131.956364c-12.8 0-23.272727-10.472727-23.272727-23.272727v-58.181819c0-4.189091-8.843636-11.636364-23.272727-11.636363s-23.272727 7.447273-23.272728 11.636363v58.181819c0 12.8-10.472727 23.272727-23.272727 23.272727H465.454545c-12.8 0-23.272727-10.472727-23.272727-23.272727s10.472727-23.272727 23.272727-23.272728h124.043637v-34.909091c0-32.581818 30.72-58.181818 69.818182-58.181818s69.818182 25.6 69.818181 58.181818v34.909091H814.545455v-232.727272H209.454545v232.727272h93.789091c12.8 0 23.272727 10.472727 23.272728 23.272728s-10.472727 23.272727-23.272728 23.272727H186.181818c-12.8 0-23.272727-10.472727-23.272727-23.272727v-279.272728c0-12.8 10.472727-23.272727 23.272727-23.272727h651.636364c12.8 0 23.272727 10.472727 23.272727 23.272727v279.272728c0 12.8-10.472727 23.272727-23.272727 23.272727z" fill="#FFFFFF" />
                            <path d="M837.818182 636.276364H186.181818c-12.8 0-23.272727-10.472727-23.272727-23.272728v-69.818181c0-11.403636 8.145455-20.945455 19.316364-22.807273l244.596363-43.054546V124.276364c0-26.065455 23.970909-46.545455 54.225455-46.545455h62.138182c30.487273 0 54.225455 20.48 54.225454 46.545455V477.090909l244.596364 43.054546c11.170909 1.861818 19.316364 11.636364 19.316363 22.807272v69.818182A23.738182 23.738182 0 0 1 837.818182 636.276364z m-628.363637-46.545455h605.09091v-26.996364l-244.596364-43.054545a23.202909 23.202909 0 0 1-19.316364-22.807273V126.138182a13.172364 13.172364 0 0 0-7.68-2.094546h-62.138182c-3.723636 0-6.516364 1.163636-7.68 2.094546v370.269091c0 11.403636-8.145455 20.945455-19.316363 22.807272L209.454545 562.734545v26.996364z" fill="#FFFFFF" />
                        </svg>
