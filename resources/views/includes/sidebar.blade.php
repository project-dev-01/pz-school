                ...
                @if(Session::get('role_id'))
                    ...
                    @if(Session::get('school_roleid')=='1')
						@foreach($mainmenu['data'] as $menu)
                                @if($menu['menu_status']==1)
                                    ...
                                    @if($menu['menu_permission']=='Access' )
                                        ...
                                        @endphp
                                        <li>
                                            <a href="{{ $url }}" @if($menu['menu_dropdown']=='Yes') data-toggle="collapse" class="collapsed" aria-expanded="false" @endif>
                                                <!--<i class="fe-edit"></i>-->
                                                {!! $menu['menu_icon'] !!}
                                                    ...
                                                    @foreach($submenu['data'] as $menu1)
                                                        @if($menu1['menu_status']==1)
                                                            @if($menu1['menu_permission']=='Access')
                                                                ...
                                                                @endphp	
                                                                <li>
                                                                    <a href="{{ $url1 }}"  @if($menu1['menu_dropdown']=='Yes') data-toggle="collapse" class="collapsed" aria-expanded="false" @endif>
                        ...
                        @else        
                            @foreach($mainmenu['data'] as $menu)
                                @if($menu['menu_status']==1)
                                    @if($menu['menu_permission']=='Access' && $menu['menu_id']!='12')
                                        @php
                                        if($menu['menu_dropdown']=='Yes')				
                                            $url=$menu['menu_url'];	
                                        else
