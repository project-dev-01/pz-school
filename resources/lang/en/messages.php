...
return [
    ...
    "guideline" => "Guideline",
    "about_forum" => "About Forum is a community of creatives who come together to share ideas and help each other succeed. As the basis for our educational delivery system Forum paves the path for global, high-impact new and expanded programs. Rather than a one-way conduit for information sharing or a repurposed business conferencing tool, the learning environment offers a deeply engaging digital experience for learners and instructors alike. Its robust features, varied learning modalities, and data gathering and management tools offer capabilities and insights not available in any other platform. Contact Us Please feel free to leave us a message at sample@sample.com",
    "new_post" => "New Post",
    "topic_title" => "Topic Title: Describe your topic well, while keeping the subject as short as possible.",
    "topic_type" => "Topic Type: Discussion / Question / Technology / Other",
    "topic_header" => "Topic Header: describe your topic header",
    ...
    "achool_maintains_a_high" => "School maintains a high standard of cleanliness and hygiene. There are regular checks and monitoring by the school administration as well as the principal of the school.",
    ...
    "we_strive_to maintain" => "We strive to maintain a ratio of 30 Students in each class.",
    "week" => "Week",
    "list" => "List",
