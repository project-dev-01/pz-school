                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data && data.data.length > 0) {
                            console.log('ok');
                            $('#group-table_wrapper .buttons-csv').removeClass('disabled');
                            $('#group-table_wrapper .buttons-pdf').removeClass('disabled');  // Enable all buttons if at least one record exists
                        } else {
                            console.log(data);
                            $('#group-table_wrapper .buttons-csv').addClass('disabled');
                            $('#group-table_wrapper .buttons-pdf').addClass('disabled');               
                        }
                    },
                    error: function() {
                        console.log('error');
