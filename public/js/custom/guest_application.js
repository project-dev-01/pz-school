$(function () {
    ...
    $('#nric_photo').change(function () {
        ...
        if (file.size > 10485760) { // 10MB = 10 * 1024 * 1024 bytes
            $('#nric_photo_name').text("File greater than 10Mb");
    ...
    // if localStorage
    if (typeof guest_application_list_storage !== 'undefined') {
        if ((guest_application_list_storage)) {
            if (guest_application_list_storage) {
                var adminApplicationListStorage = JSON.parse(guest_application_list_storage);
