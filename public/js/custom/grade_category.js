$(function () {
    ...
    var table = $('#grade-category-table').DataTable({
        ...
        initComplete: function () {
            var table = this;
            $.ajax({
                url: gradeCategoryList,
                success: function(data) {
                    console.log(data.data.length);
                    if (data && data.data.length > 0) {
                        console.log('ok');
                        $('#grade-category-table_wrapper .buttons-csv').removeClass('disabled');
                        $('#grade-category-table_wrapper .buttons-pdf').removeClass('disabled');  // Enable all buttons if at least one record exists
                    } else {
                        console.log(data);
                        $('#grade-category-table_wrapper .buttons-csv').addClass('disabled');
                        $('#grade-category-table_wrapper .buttons-pdf').addClass('disabled');               
                    }
                },
                error: function() {
                    console.log('error');
