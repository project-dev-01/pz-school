$(function () {
    ...
    var table = $('#academic-year-table').DataTable({
        ...
        initComplete: function () {
            var table = this;
            $.ajax({
                url: academicYearList,
                success: function(data) {
                    console.log(data.data.length);
                    if (data && data.data.length > 0) {
                        console.log('ok');
                        $('#academic-year-table_wrapper .buttons-csv').removeClass('disabled');
                        $('#academic-year-table_wrapper .buttons-pdf').removeClass('disabled');  // Enable all buttons if at least one record exists
                    } else {
                        console.log(data);
                        $('#academic-year-table_wrapper .buttons-csv').addClass('disabled');
                        $('#academic-year-table_wrapper .buttons-pdf').addClass('disabled');               
                    }
                },
                error: function() {
                    console.log('error');
