$(function () {
    ...
    shortcutTable();
    $("#shortcutLinkTeacherForm").validate({
        rules: {
            name: "required",
            link: "required"
        }
    ...
    // add bank
    $('#shortcutLinkTeacherForm').on('submit', function (e) {
        e.preventDefault();
        var bankCheck = $("#shortcutLinkTeacherForm").valid();
        if (bankCheck === true) {
            var form = this;
 console.log("kjihug");
            $.ajax({
                ...
                success: function (data) {
                    ...
                    console.log(data)
                    if (data.code == 200) {
                        $('#shortcut-teacher-table').DataTable().ajax.reload(null, false);
    ...
    function shortcutTable() {
         $('#shortcut-teacher-table').DataTable({
            processing: true,
            info: true,
            // dom: 'lBfrtip',
