$(document).ready(function () {
    ...
    var department_increment = parseInt($("#addRemovedepartment").val());
    ...
    var designation_increment = parseInt($("#addRemoveDesignation").val());
    ...
    var emp_type_increment = parseInt($("#addRemoveLastEmpType").val());
