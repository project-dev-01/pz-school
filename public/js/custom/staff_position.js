    ...
    function staffPositionTable() {
        $('#staff-position-table').DataTable({
            ...
            initComplete: function () {
                var table = this;
                $.ajax({
                    url: staffPositionList,
                    success: function(data) {
                        console.log(data.data.length);
                        if (data && data.data.length > 0) {
                            console.log('ok');
                            $('#staff-position-table_wrapper .buttons-csv').removeClass('disabled');
                            $('#staff-position-table_wrapper .buttons-pdf').removeClass('disabled');  // Enable all buttons if at least one record exists
                        } else {
                            console.log(data);
                            $('#staff-position-table_wrapper .buttons-csv').addClass('disabled');
                            $('#staff-position-table_wrapper .buttons-pdf').addClass('disabled');               
                        }
                    },
                    error: function() {
                        console.log('error');
