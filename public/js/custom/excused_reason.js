    ...
    function excusedReasonTable() {
        $('#excused-reason-table').DataTable({
            ...
            initComplete: function () {
                var table = this;
                $.ajax({
                    url: excusedReasonList,
                    success: function(data) {
                        console.log(data.data.length);
                        if (data && data.data.length > 0) {
                            console.log('ok');
                            $('#excused-reason-table_wrapper .buttons-csv').removeClass('disabled');
                            $('#excused-reason-table_wrapper .buttons-pdf').removeClass('disabled');  // Enable all buttons if at least one record exists
                        } else {
                            console.log(data);
                            $('#excused-reason-table_wrapper .buttons-csv').addClass('disabled');
                            $('#excused-reason-table_wrapper .buttons-pdf').addClass('disabled');               
                        }
                    },
                    error: function() {
                        console.log('error');
