    ...
    function hostelCategoryTable() {
        $('#hostel-category-table').DataTable({
            ...
            initComplete: function () {
                var table = this;
                $.ajax({
                    url: hostelCategoryList,
                    success: function(data) {
                        console.log(data.data.length);
                        if (data && data.data.length > 0) {
                            console.log('ok');
                            $('#hostel-category-table_wrapper .buttons-csv').removeClass('disabled');
                            $('#hostel-category-table_wrapper .buttons-pdf').removeClass('disabled');  // Enable all buttons if at least one record exists
                        } else {
                            console.log(data);
                            $('#hostel-category-table_wrapper .buttons-csv').addClass('disabled');
                            $('#hostel-category-table_wrapper .buttons-pdf').addClass('disabled');               
                        }
                    },
                    error: function() {
                        console.log('error');
