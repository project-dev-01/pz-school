$(function () {
    ...
    function layoutMode(res, date) {
        ...
        if (res.att_status) {
            ...
            if (res.current_old_att_status == "present") {
                bgColor = "#60a05b";
            } else if (res.current_old_att_status == "absent") {
                bgColor = "#de354f";
            } else if (res.current_old_att_status == "late") {
                bgColor = "#358fde";
            } else if (res.current_old_att_status == "excused") {
                bgColor = "#696969";
            }
